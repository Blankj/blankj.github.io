;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="f19cb38fbe4fa435f4fef92c51101edd";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["1D8idUkKyomy"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["1D8idUkKyomy"].options={"id":"UA-41022772-1","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['1D8idUkKyomy'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['1D8idUkKyomy'].URLPatterns)){(function(){var options=CloudflareApps.installs['1D8idUkKyomy'].options
